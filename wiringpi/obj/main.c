...
int main(void)
{
  ...
  */  
    ...
    Paint_SelectImage(BlackImage);
    GUI_ReadBmp("./pic/029-1yb1.bmp", 0, 0);
    printf("read red bmp\r\n");
    Paint_SelectImage(RedImage);
    GUI_ReadBmp("./pic/029-1yy1.bmp", 0, 0);
    EPD_Display(BlackImage, RedImage);
    DEV_Delay_ms(2000);
    ...
    printf("read black bmp\r\n");
    Paint_SelectImage(BlackImage);
    GUI_ReadBmp("./pic/029-1yb2.bmp", 0, 0);
    printf("read red bmp\r\n");
    Paint_SelectImage(RedImage);
    GUI_ReadBmp("./pic/029-1yy2.bmp", 0, 0);
    EPD_Display(BlackImage, RedImage);
    DEV_Delay_ms(2000);
